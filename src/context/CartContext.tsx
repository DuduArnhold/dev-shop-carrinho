...
//verifica se ja não existe o item no carrinho
        ...
        function removeCartItem(product: CartProps){
            ...
            if(cart[indexItem]?.amount > 1){
                    //Diminuir apenas 1 item da lista de items
                const cartList = cart;
        ...
        function totalResultCart(items: CartProps[]){
            ...
            const format = result.toLocaleString("pr-BR", {style: "currency", currency: "BRL"})
    ...
    return(
            ...
            value={{ cart, cartAmount: cart.length, addItemCart, removeCartItem, total }}
            >
                {children}
